...
* [Create the database, populate it with initial data, and update the configuration key](https://docs.omisego.co/docs/install-ewallet-server#section-create-and-update-the-database)
* [Upgrade eWallet Server](https://docs.omisego.co/docs/upgrade-ewallet-server)


## Documentation

Documentation can found at the [OmiseGO developer docs website](https://docs.omisego.co/docs), and in the GitHub [docs](docs/) directory. Ensure you're viewing the documentation of the OmiseGO eWallet Server you're running.

### API documentation

Since the provider runs the eWallet Server, the API documentation is available at the following internal directories:
...
If you wish to explore the API documentation without installing the OmiseGO eWallet Server, you may use our [OmiseGO eWallet Staging](https://ewallet.staging.omisego.io/). Please note that OmiseGO eWallet Staging tracks development release and there might be API differences from the stable release.
...
SDKs are available for integrating with the OmiseGO eWallet Server; for example, to integrate a loyalty point system built on OmiseGO eWallet Server into an existing system.
...
We're grateful to our community for creating and maintaining these wonderful works that we otherwise could not have done ourselves. If you have ported any part of the OmiseGO eWallet Server to another platform, we will be happy to list them here. [Submit a pull request](https://github.com/omisego/ewallet/pulls).
