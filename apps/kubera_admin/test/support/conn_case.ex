defmodule KuberaAdmin.ConnCase do
  ...
  setup do
    ...
    _api_key    = insert(:api_key, %{id: @api_key_id, key: @api_key, owner_app: "kubera_admin"})
    _auth_token = insert(:auth_token, %{user: user, token: @auth_token, owner_app: "kubera_admin"})
