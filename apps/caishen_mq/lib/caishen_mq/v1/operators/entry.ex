defmodule CaishenMQ.V1.Operators.Entry do
  @moduledoc """
  Entry operator (similar to a web controller) receive and handles operations.
  """
  alias CaishenMQ.ErrorHandler
  alias CaishenMQ.V1.Serializers
  alias CaishenMQ.V1.Serializers.Response
      ...
      {:error, changeset} ->
        ...
        case correlation_error do
          ...
          _error ->
            ...
            |> Caishen.Entry.get_with_correlation_id
            |> serialize
        end
    end
  rescue
    e in CaishenDB.Errors.InsufficientFundsError ->
