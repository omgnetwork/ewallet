...
const createRoute = ({ authenticated }) => (
  <Router basename='/admin'>
    <Switch>
      ...
      {/* OVERVIEW */}
      <AuthenticatedRoute authenticated={authenticated} path='/users/:userId/:type' exact component={() => <UserDetailPage withBreadCrumb />} />
      <AuthenticatedRoute authenticated={authenticated} path='/users/:userId' excact component={() => <UserDetailPage withBreadCrumb />} />
