defmodule Kubera.Web.PaginatorTest do
  use Kubera.DBCase
  import Ecto.Query
  alias Kubera.Web.Paginator
  alias KuberaDB.{Repo, Account}

  describe "Kubera.Web.Paginator.paginate_attrs/2" do
  ...
  describe "Kubera.Web.Paginator.paginate/3" do
    test "returns a Kubera.Web.Paginator with data and pagination attributes" do
  ...
  describe "Kubera.Web.Paginator.fetch/3" do
