defmodule Caishen.TransactionTest do
  use ExUnit.Case
  import CaishenDB.Factory
  alias Ecto.Adapters.SQL.Sandbox
  alias Caishen.Transaction
  alias CaishenDB.{Repo, Entry, Errors.InsufficientFundsError}
  alias Ecto.UUID
