defmodule Caishen.Entry do
  @moduledoc """
  This module is an interface to the CaishenDB schemas and contains the logic
  needed to insert valid entries and transactions.
  """
  alias CaishenDB.Entry
  alias Caishen.{Transaction, Balance}
  alias Caishen.Entry.Validator
