...
defmodule AdminAPI.V1.BlockchainWalletController do
  ...
  def create(conn, %{"type" => _}) do
    handle_error(conn, :invalid_parameter, "Invalid parameter error. The specified `type` is not currently supported.")
  end

  def create(conn, _) do
    handle_error(conn, :invalid_parameter, "Invalid parameter provided. `type`, `address` and `name` are required.")
  end
