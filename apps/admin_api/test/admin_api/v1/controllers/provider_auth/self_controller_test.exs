defmodule AdminAPI.V1.ProviderAuthSelfControllerTest do
  ...
  describe "/me.update" do
    ...
    test "doesn't update params that are not provided" do
      user = get_test_admin()
      response = provider_request("/me.update", %{})
    ...
    test "ignore additional/invalid params" do
      user = get_test_admin()
      response = provider_request("/me.update", %{provider_user_id: "test_puid_1337"})
    ...
    test "raise an error if the update is not valid" do
      ...
      response = provider_request("/me.update", %{email: "user1@example.com"})
  ...
  describe "/me.get_account" do
    test "responds with an account" do
      ...
      assert provider_request("/me.get_account") ==
               %{
                 "version" => "1",
                 "success" => true,
                 "data" => %{
  ...
  describe "/me.get_accounts" do
    test "responds with a list of accounts" do
      ...
      assert provider_request("/me.get_accounts") ==
               %{
                 "version" => "1",
                 "success" => true,
                 "data" => %{
