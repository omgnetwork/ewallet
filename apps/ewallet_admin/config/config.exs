...
config :ewallet_admin,
  namespace: EWalletAdmin

# Configs for the endpoint
config :ewallet_admin,
  EWalletAdmin.Endpoint,
  url: [host: "localhost"],
  secret_key_base: System.get_env("SECRET_KEY_BASE"),
  render_errors: [
    view: EWalletAdmin.ErrorView,
    accepts: ~w(json),
    default_format: "json"
  ]
...
config :ewallet_admin, :generators,
  context_app: false
...
config :ewallet_admin, :api_versions, %{
  "application/vnd.omisego.v1+json" => EWalletAdmin.V1.Router
}
