defmodule EWalletAdmin.V1.UserAuthPlug do
  @moduledoc """
  ...
  alias EWalletAdmin.V1.ClientAuthPlug
  ...
  defp authenticate_token(conn) do
    ...
    case AuthToken.authenticate(user_id, auth_token, :ewallet_admin) do
      false ->
        conn
        |> assign(:authenticated, false)
  ...
  def expire_token(conn) do
    ...
    AuthToken.expire(token_string, :ewallet_admin)
