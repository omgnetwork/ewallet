defmodule KuberaMQ.Serializers.Transaction do
  ...
  """
  def serialize(%{from: from, to: to, minted_token: minted_token,
    ...
    %{
      ...
      debits: [%{
        address: from.address, amount: amount, metadata: from.metadata
      }],
      credits: [%{
        address: to.address, amount: amount, metadata: to.metadata
      }]
    }
  end
end
