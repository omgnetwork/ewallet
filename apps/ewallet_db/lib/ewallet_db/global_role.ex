...
defmodule EWalletDB.GlobalRole do
  ...
  @global_role_permissions %{
    ...
    "admin" => %{
      ...
      admin_users: %{all: :accounts, get: :accounts, update: :accounts, disable: :accounts, update_password: :self, update_email: :self, upload_avatar: :self, get_account: :self, get_accounts: :self},
      end_users: %{
        all: :global,
        get: :global,
        listen: :global,
