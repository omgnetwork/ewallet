defmodule EWalletDB.Repo.Migrations.RenameMintedTokenToToken do
  ...
  def change do
    ...
    each(tables, fn table, old_name, _new_name ->
      regenerate_constraint(table, old_name)
    end)
  ...
  defp regenerate_constraint(:transaction_consumption, _old_name) do
  ...
  defp regenerate_constraint(:wallet, _old_name) do
  ...
  defp regenerate_constraint(table, old_name) do
