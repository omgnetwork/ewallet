  ...
  def seed do
    ...
    [
      ...
      argsline: [
        ...
        {:input, {:integer, :blockchain_default_gas_price, settings["blockchain_default_gas_price"].description,
          settings["blockchain_default_gas_price"].value}},
        {:input, {:integer, :blockchain_confirmations_threshold, settings["blockchain_confirmations_threshold"].description,
          settings["blockchain_confirmations_threshold"].value}},
        {:input, {:text, :omisego_plasma_framework_address, settings["omisego_plasma_framework_address"].description,
          settings["omisego_plasma_framework_address"].value}},
        ...
        {:input, {:text, :omisego_erc20_vault_address, settings["omisego_erc20_vault_address"].description,
          settings["omisego_erc20_vault_address"].value}},
        {:input, {:text, :omisego_payment_exit_game_address, settings["omisego_payment_exit_game_address"].description,
          settings["omisego_payment_exit_game_address"].value}},
