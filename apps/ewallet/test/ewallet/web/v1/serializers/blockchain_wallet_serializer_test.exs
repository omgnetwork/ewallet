  ...
  describe "serialize/1" do
    test "serializes a blockchain wallet into a blockchain wallet object" do
      ...
      expected = %{
        ...
        name: wallet.name,
        type: wallet.type,
        blockchain_identifier: wallet.blockchain_identifier,
      ...
      expected = %{
        ...
        data: [
          %{
            ...
            name: wallet_1.name,
            type: wallet_1.type,
            blockchain_identifier: wallet_1.blockchain_identifier,
          ...
          %{
            ...
            name: wallet_2.name,
            type: wallet_2.type,
            blockchain_identifier: wallet_2.blockchain_identifier,
