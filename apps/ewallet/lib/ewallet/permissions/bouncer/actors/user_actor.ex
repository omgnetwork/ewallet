...
defmodule EWallet.Bouncer.UserActor do
  ...
  # def get_query_actor_records(%Permission{type: type, global_abilities: %{type => :global}, actor: %User{is_admin: true} = actor}) do
  ...
  # def get_query_actor_records(%Permission{global_abilities: %{account_wallets: :accounts, }, actor: %User{is_admin: true} = actor}) do
